...
use Sanlilin\LaravelTheme\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    {
        return isset($this->isCache) ? $this->isCache : config('theme.cache.enabled') ?? false;
    }
    ...
    public function getAttributes(): array
    {
        ...
        return app('cache')->remember($this->getPath(), config('theme.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
