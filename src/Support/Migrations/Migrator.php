...
namespace Sanlilin\LaravelTheme\Support\Migrations;
...
class Migrator
{
     ...
     */
    public function __construct(Theme $theme, Application $application)
    {
        $this->theme = $theme;
    ...
    {
        $config = $this->theme->get('migration');
        ...
        return $this->theme->getExtraPath($path);
    }
